...
class RoleController extends Controller
{
    ...
    public function getRoles()
    {
        ...
        return datatables()->of($roles)
            ...
            $buttonEdit = '<button data-toggle="tooltip" data-placement="top" title="Edit Produk" data-id="'.$role->id.'" id="editButton" class="btn btn-info mr-2"><i class="fas fa-edit"></i></button>';
